...
export const ja: LocaleDict = {
  ...
  'This run: +15% attack speed.': 'このラン中: 攻撃速度+15%。',
  'This run: +30% attack speed.': 'このラン中: 攻撃速度+30%。',
  'This run: +50% attack speed.': 'このラン中: 攻撃速度+50%。',
  'This run: +5% damage reduction.': 'このラン中: ダメージ軽減+5%。',
  'This run: +10% damage reduction.': 'このラン中: ダメージ軽減+10%。',
  'This run: +20% damage reduction.': 'このラン中: ダメージ軽減+20%。',
  'This run: enemy takes +10% damage.': 'このラン中: 敵の被ダメージ+10%。',
  'This run: enemy takes +20% damage.': 'このラン中: 敵の被ダメージ+20%。',
  'This run: enemy takes +35% damage.': 'このラン中: 敵の被ダメージ+35%。',
