...
// SANCTUM scrap pricing — current values are baseline ×3 (1.5× from the
// 2026-04-26 first directive, then ×2 from the second directive of the
// same day). Build-shop item appearance is disabled (itemShopChance: 0)
// so this raise affects SANCTUM scrap costs only; if items return to the
// shop later, the gold-side balance will need a separate review.
export const ITEMS = {
